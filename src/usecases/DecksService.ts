...
export class DecksService implements DeckRepository{
    getAllDecks(colors: string[]): Array<DeckEntity> {
        ...
        decks.push(new DeckEntity('https://www.artofmtg.com/wp-content/uploads/2015/08/Forest-Mtg-Art.jpg'));
        decks.push(new DeckEntity('https://www.artofmtg.com/wp-content/uploads/2014/03/Fated-Conflagration-Art.jpg'));
        return decks;
    }
